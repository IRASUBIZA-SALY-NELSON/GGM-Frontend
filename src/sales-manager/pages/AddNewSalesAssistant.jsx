    ...
    <div className="flex-1 p-6 bg-white min-h-screen">
      ...
      <div className="flex justify-between items-center mb-8">
        <div>
          ...
          <h1 className="text-2xl font-bold text-gray-900">Add New Sales Assistant</h1>
        </div>
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200">
        ...
        <div className="flex border-b border-gray-200">
          <div className="flex items-center space-x-2 px-6 py-4 text-sm font-medium border-b-2 border-purple-600 text-purple-600">
        ...
        <div className="p-8">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex justify-end space-x-3 pt-6">
              <button
                type="button"
                onClick={() => navigate('/sales-manager/my-team')}
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 w-96 max-w-md text-center">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-2">
              User will receive Invitation Via Email
            </h3>
            <p className="text-sm text-gray-500 mb-6">
              User invited successfully via email
            </p>
            <button
...
export default AddNewSalesAssistant;
