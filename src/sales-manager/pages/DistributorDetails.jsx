...
import { Search, Bell, ChevronDown, ArrowLeft, Filter, Eye, CheckCircle, XCircle } from 'lucide-react';
      ...
      <div className="flex justify-between items-center mb-8">
        <div>
          <div className="flex items-center space-x-2 text-sm text-gray-500 mb-2">
            ...
            <span>/</span>
            <span>Distributor ID: {distributorId}</span>
          </div>
          <h1 className="text-2xl font-bold text-gray-900">Distributor Management</h1>
          <p className="text-sm text-gray-500">All Distributors &gt; Distributor ID: {distributorId}</p>
        </div>
          ...
          {chartData.map((item, index) => (
            <div key={index} className="flex flex-col items-center space-y-2 flex-1">
              <div className="relative w-full flex items-end justify-center" style={{ height: '280px' }}>
                <div 
                  className={`w-16 ${item.color} rounded-t-lg transition-all duration-300 hover:opacity-80`}
