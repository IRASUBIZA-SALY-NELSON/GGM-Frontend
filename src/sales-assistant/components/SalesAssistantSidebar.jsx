...
const SalesAssistantSidebar = () => {
  ...
  const navigationItems = [
    {
      name: 'Dashboard',
      href: '/sales-assistant/dashboard',
      icon: LayoutDashboard,
    },
    {
      name: 'Orders',
      href: '/sales-assistant/orders',
      icon: ShoppingCart,
    },
    {
      name: 'Distributors',
      href: '/sales-assistant/distributors',
      icon: Users,
    },
    {
      name: 'Products',
      href: '/sales-assistant/products',
      icon: Package,
    },
  ];
...
export default SalesAssistantSidebar;
